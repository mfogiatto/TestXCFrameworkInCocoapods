...
SWIFT_CLASS_NAMED("CrashModel")
@interface CrashModel : NSManagedObject
...
@interface CrashModel (SWIFT_EXTENSION(SecLibFramework))
@property (nonatomic, strong) NSObject * _Nullable crashReport;
@property (nonatomic, copy) NSString * _Nullable crashId;
@end



SWIFT_CLASS("_TtC15SecLibFramework11EventHeader")
@interface EventHeader : NSObject
...
@property (nonatomic, strong) NSObject * _Nullable payload;
@property (nonatomic, copy) NSDate * _Nullable timestamp;
@property (nonatomic, strong) NSObject * _Nullable user;
...
@property (nonatomic, copy) NSString * _Nonnull setTraceIdKey;
...
@property (nonatomic) BOOL turnSMAPIOnOff;
/// Setup Method for initializing SecLib
/// UserID can be a username, email of type String
/// Set Verbose for console logging
/// Environment value should be either PROD or PREPROD
/// Set CrashHandling for CrashLogs
- (void)setupWithEnvironment:(NSString * _Nonnull)environment crashHandling:(BOOL)crashHandling;
- (void)flush;
- (NSURL * _Nonnull)appendSessionFor:(NSURL * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic) BOOL configureNetworkMonitoring;
...
- (void)setVerboseWithFlag:(BOOL)flag;
- (void)setEnvironmentWithEnvironment:(NSString * _Nullable)environment;
- (NSString * _Nonnull)getUserId SWIFT_WARN_UNUSED_RESULT;
- (EventHeader * _Nonnull)getSecLibHeaderObject SWIFT_WARN_UNUSED_RESULT;
- (BOOL)getSMAPIStatus SWIFT_WARN_UNUSED_RESULT;
- (void)logExceptionEventWithEventElement:(NSString * _Nonnull)eventElement exception:(NSString * _Nonnull)exception;
- (void)throtleLocalEndPointWithEndPoint:(NSArray<NSString *> * _Nullable)endPoint bundleID:(NSString * _Nullable)bundleID;
@end
...
- (void)customDismissWithAnimated:(BOOL)flag completion:(void (^ _Nullable)(void))completion;
@end
